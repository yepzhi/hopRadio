      ...
      <div className="absolute bottom-2 w-full flex flex-col md:flex-row justify-between items-end px-8 z-20 pointer-events-none gap-2 md:gap-0">
        ...
        <div className="pointer-events-auto">
          <div className="text-gray-600 text-[10px] tracking-wide">
            Created by <a href="https://yepzhi.com" target="_blank" rel="noreferrer" className="text-red-700 hover:text-red-500 transition-colors font-bold">@yepzhi</a> <span className="text-gray-500">v2.1.3</span>
          </div>
        </div>
      </div>
